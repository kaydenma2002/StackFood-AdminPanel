    ...
    <div class="resturant-card-navbar px-xl-4 justify-content-evenly">
        <div class="order-info-item">
            <div class="order-info-icon icon-sm">
                ...
                ->where(['restaurant_id'=>$restaurant->restaurant_id])->count())
        ...
        <div class="order-info-item">
            <div class="order-info-icon icon-sm">
                ...
                @php($food = \App\Models\Food::withoutGlobalScope(\App\Scopes\RestaurantScope::class)->
                where(['restaurant_id'=>$restaurant->restaurant_id, 'status'=>1])->count())
                @php($food = ($food == null) ? 0 : $food)
        ...
        <div class="order-info-item">
            <div class="order-info-icon icon-sm">
                ...
                @php($food = \App\Models\Food::withoutGlobalScope(\App\Scopes\RestaurantScope::class)->
                where(['restaurant_id'=>$restaurant->restaurant_id, 'status'=>0])->count())
                @php($food = ($food == null) ? 0 : $food)
            ...
            <div class="search--button-wrapper">
                ...
                <div class="hs-unfold ml-3 mr-3">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a target="__blank" id="export-excel" class="dropdown-item" href="{{route('admin.food.restaurant-food-export', ['type'=>'excel', 'restaurant_id'=>$restaurant->restaurant_id, request()->getQueryString()])}}">
                        ...
                        <a target="__blank" id="export-csv" class="dropdown-item" href="{{route('admin.food.restaurant-food-export', ['type'=>'csv', 'restaurant_id'=>$restaurant->restaurant_id, request()->getQueryString()])}}">
                            <img class="avatar avatar-xss avatar-4by3 mr-2"

...
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="mt-4 pt-2">
                    ...
                    <div class="__btn-container btn--container justify-content-end">
                                ...
                                <button class="btn btn--danger h--45px form-alert" href="javascript:"
                                data-id="subscription-{{ $restaurant->restaurant_id }}" data-message="{{ translate('messages.You_want_to_Cancel_the_Plan_for') }} {{ $restaurant->name }}"
                                >  <span class="ml-1">{{ translate('Cancel_Subscription') }}</span>
                            </button>
                            <form action="{{ route('admin.subscription.package_cancel', [$restaurant->restaurant_id]) }}" method="post"
                                id="subscription-{{ $restaurant->restaurant_id }}">
                                @csrf @method('delete')
                    ...
                    <div class="__plan-item">
                        ...
                        <div class="__plan">
                            ...
                            <ul class="plan-info">
                                @if ($package->pos)
                                <li>
                                    <img class="plan-info-icon" src="{{dynamicAsset('/public/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.POS') }}
                                </li>
                                @endif
    ...
    <input type="hidden" id="myInput" value="{{ $restaurant->restaurant_id }}">
        @endsection

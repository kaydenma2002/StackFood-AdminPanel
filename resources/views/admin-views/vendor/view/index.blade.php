...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <a href="{{route('admin.restaurant.edit',[$restaurant->restaurant_id])}}" class="btn btn--primary my-2">
            ...
            <div>
                ...
                <a class="btn btn--danger text-capitalize my-2 request_alert"
                    data-url="{{route('admin.restaurant.application',[$restaurant['restaurant_id'],0])}}" data-message="{{translate('messages.you_want_to_deny_this_application')}}"
                    href="javascript:">{{translate('messages.deny')}}</a>
                @endif
                <a class="btn btn--primary text-capitalize my-2 request_alert"
                    data-url="{{route('admin.restaurant.application',[$restaurant['restaurant_id'],1])}}" data-message="{{translate('messages.you_want_to_approve_this_application')}}"

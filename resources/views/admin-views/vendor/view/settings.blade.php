    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->food_section?0:1, 'food_section'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->schedule_order?0:1, 'schedule_order'])}}"
                    ...
                    @if ($restaurant->restaurant_model == 'commission')
                        ...
                        <span class="pr-2 d-flex">
                            ...
                            <span data-toggle="tooltip" data-placement="right"
                                ...
                                <form
                                    action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->reviews_section?0:1, 'reviews_section'])}}"
                        ...
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            ...
                            <span class="pr-2 d-flex">
                                ...
                                <form
                                    action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->pos_system?0:1, 'pos_system'])}}"
                        ...
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            ...
                            <span class="pr-2 d-flex">
                                ...
                                <form
                                    action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->self_delivery_system?0:1, 'self_delivery_system'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->delivery?0:1, 'delivery'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->take_away?0:1, 'take_away'])}}"
                    ...
                    @if (isset($order_subscription) && $order_subscription->value == 1)
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            <div class="form-group mb-0">
                                ...
                                <form
                                    action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->order_subscription_active?0:1, 'order_subscription_active'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->restaurant_config?->instant_order?0:1, 'instant_order'])}}"
                    ...
                    @if ($self_delivey  == 1 )
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            <div class="form-group mb-0">
                                ...
                                <form
                                    action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->restaurant_config?->customer_date_order_sratus?0:1, 'customer_date_order_sratus'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('admin.restaurant.toggle-settings',[$restaurant->restaurant_id,$restaurant->restaurant_config?->halal_tag_status?0:1, 'halal_tag_status'])}}"
                ...
                <form action="{{route('admin.restaurant.update-settings',[$restaurant['restaurant_id']])}}" method="post"
        ...
        <form action="{{route('admin.restaurant.update-settings',[$restaurant['restaurant_id']])}}" id="Business_Model_change"
              method="post">
            @csrf
            <div class="card mb-3">
                <div class="card-header">

                    ...
                    <div class="search--button-wrapper">
                        ...
                        <div class="hs-unfold mr-2">
                            ...
                            <div id="usersExportDropdown"
                                ...
                                <a id="export-excel" class="dropdown-item" href="{{route('admin.restaurant.restaurant_wise_reviwe_export', ['type'=>'excel', 'id' => $restaurant->restaurant_id,request()->getQueryString()])}}">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"
                                        src="{{ dynamicAsset('public/assets/admin') }}/svg/components/excel.svg"
                                        alt="Image Description">
                                    {{ translate('messages.excel') }}
                                </a>
                                <a id="export-csv" class="dropdown-item" href="{{route('admin.restaurant.restaurant_wise_reviwe_export', ['type'=>'csv','id' => $restaurant->restaurant_id,request()->getQueryString()])}}">
                                    <img class="avatar avatar-xss avatar-4by3 mr-2"

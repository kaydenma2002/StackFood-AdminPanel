            ...
            <div class="card-body">
                <div class="qr-area row gy-4">
                    <div class="col-lg-6 col-xl-5 left-side">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="btn--container flex-nowrap print-btn-grp">
                                <a type="button" href="{{ route('admin.restaurant.qrcode.print',[$restaurant['restaurant_id']]) }}" class="btn btn-primary pt-1"><i class="tio-print"></i> {{translate('Print')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-xl-7 right-side">
                        <form method="post" action="{{ route('admin.restaurant.qrcode.store',[$restaurant['restaurant_id']]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">

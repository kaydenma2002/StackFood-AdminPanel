    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="vendor">
            <div class="card">
                ...
                @php($default_lang = 'en')
                <div class="card-body">
                    <form action="{{route('admin.restaurant.update-meta-data',[$restaurant['restaurant_id']])}}" method="post"
                                ...
                                <div class="card shadow--card-2">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs mb-4">
                                            ...
                                            <?php
                                                    $restaurant = \App\Models\Restaurant::withoutGlobalScope('translate')->with('translations')->findOrFail($restaurant->restaurant_id);
                                            ?>

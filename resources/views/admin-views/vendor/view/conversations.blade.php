                    ...
                    <div class="row g-3">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card">
                                ...
                                <input type="hidden" id="vendor_id" value="{{ $restaurant->restaurant_id }}">
                                <!-- Body -->
...
<script>
    ...
    function viewConvs(url, id_to_active, conv_id, sender_id) {
        ...
        let new_url= "{{route('admin.restaurant.view', ['restaurant'=>$restaurant->restaurant_id, 'tab'=> 'conversations'])}}" + '?conversation=' + conv_id+ '&user=' + sender_id;
            $.get({
                url: url,

                ...
                <div class="page-header">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{route('admin.restaurant.edit',[$restaurant->restaurant_id])}}" class="btn btn-primary"><i class="tio-open-in-new"></i>
                                {{ translate('Edit_Information') }}</a>
                            @if($restaurant->vendor->status === null)
                                <a  data-url="{{route('admin.restaurant.application',[$restaurant['restaurant_id'],0])}}" data-message="{{translate('messages.you_want_to_reject_this_application')}}"
                            ...
                            @if($restaurant->vendor->status === null || $restaurant->vendor->status == 0 )
                                <a  data-url="{{route('admin.restaurant.application',[$restaurant['restaurant_id'],1])}}" data-message="{{translate('messages.you_want_to_approve_this_application')}}"

                        ...
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($restaurants as $key=>$dm)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.restaurant.view', $dm->restaurant_id)}}" alt="view restaurant" class="table-rest-info">
                                    ...
                                    <td>
                                        @if(isset($dm->vendor->status))
                                            @if($dm->vendor->status)
                                            <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$dm->restaurant_id}}">
                                                <input type="checkbox" data-url="{{route('admin.restaurant.status',[$dm->restaurant_id,$dm->status?0:1])}}" data-message="{{translate('messages.you_want_to_change_this_restaurant_status')}}" class="toggle-switch-input status_change_alert" id="stocksCheckbox{{$dm->restaurant_id}}" {{$dm->status?'checked':''}}>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                href="{{route('admin.restaurant.edit',[$dm['restaurant_id']])}}" title="{{translate('messages.edit_restaurant')}}"><i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn--warning btn-outline-warning action-btn"
                                                href="{{route('admin.restaurant.view',[$dm['restaurant_id']])}}" title="{{translate('messages.view_restaurant')}}"><i class="tio-invisible"></i>
                                            </a>
                                        </div>
                                    </td>
                                </tr>

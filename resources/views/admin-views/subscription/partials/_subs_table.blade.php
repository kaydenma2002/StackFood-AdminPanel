@foreach ($restaurants as $key => $restaurant)
    <tr>
        ...
        <td>
            <a href="{{ route('admin.restaurant.view', $restaurant['restaurant_id']) }}" class="table-rest-info">
        ...
        <td>
            <div class="btn--container justify-content-center">
                <a class="btn btn-sm btn--warning btn-outline-warning action-btn"
                    href="{{ route('admin.restaurant.view', ['restaurant' => $restaurant->restaurant_id, 'tab' => 'subscriptions']) }}"

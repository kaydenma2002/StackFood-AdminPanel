                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        <a class="btn btn-sm btn--primary btn-outline-primary action-btn" data-toggle="modal" data-target="#payment-info-{{$restaurant->restaurant_id}}" title="{{ translate('View_Details') }}">
                                            <i class="tio-visible"></i>

                                        @if($restaurant->status == 'completed')
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section" href="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->restaurant_id,'status'=>'pending'])}}" data-toggle="tooltip" title="{{ translate('Reverse_status_Back_to_Pending') }}">
                                                <i class="tio-restore"></i>
                                            </a>
                                        @else
                                            @if($restaurant->status != 'canceled')
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section form-alert-cancel" data-url="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->restaurant_id,'status'=>'canceled'])}}" data-toggle="tooltip" title="{{ translate('cancel') }}">
                                                <i class="tio-clear"></i>
                                            </a>
                                            @endif
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn action-btn-section" href="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->restaurant_id,'status'=>'completed'])}}" title="{{ translate('complete') }}" data-toggle="tooltip">
                                                <i class="tio-done"></i>
                                            </a>
                                        @endif
                                    </div>
                                </td>
                                <div class="modal fade" id="payment-info-{{$restaurant->restaurant_id}}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-3 btn--container justify-content-end">
                                                    @if($restaurant->status =='pending')
                                                    <a type="button" href="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->restaurant_id,'status'=>'canceled'])}}" class="btn btn--reset" >{{ translate('cancel') }}</a>
                                                    @endif
                                                    @if($restaurant->status != 'completed')
                                                    <a type="button" href="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->restaurant_id,'status'=>'completed'])}}" class="btn btn--primary">{{ translate('complete') }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>

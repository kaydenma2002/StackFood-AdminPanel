...
@section('content')
    <div class="content container-fluid">
                ...
                <div class="row g-3">
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->schedule_order?0:1, 'schedule_order'])}}" method="get" id="schedule_order_form">
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->delivery?0:1, 'delivery'])}}" method="get" id="delivery_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->free_delivery?0:1, 'free_delivery'])}}" method="get" id="free_delivery_form">
                            </form>
                        </div>
                    </div>
                    @endif
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->take_away?0:1, 'take_away'])}}" method="get" id="take_away_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->veg?0:1, 'veg'])}}" method="get" id="veg_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            ...
                            <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->non_veg?0:1, 'non_veg'])}}" method="get" id="non_veg_form">
                            </form>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="order_subscription_active">
                             ...
                             <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->order_subscription_active?0:1, 'order_subscription_active'])}}" method="get" id="order_subscription_active_form">
                            </form>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="cutlery">
                                ...
                                <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->cutlery?0:1, 'cutlery'])}}" method="get" id="cutlery_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="instant_order">
                                ...
                                <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant?->restaurant_config?->instant_order?0:1, 'instant_order'])}}" method="get" id="instant_order_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="customer_date_order_sratus">
                                ...
                                <form action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant?->restaurant_config?->customer_date_order_sratus?0:1, 'customer_date_order_sratus'])}}" method="get" id="customer_date_order_sratus_form">
                            </form>
                        </div>
                    </div>
                    @endif
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->restaurant_config?->halal_tag_status?0:1, 'halal_tag_status'])}}"
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <form
                                action="{{route('vendor.business-settings.toggle-settings',[$restaurant->restaurant_id,$restaurant->restaurant_config?->is_extra_packaging_active?0:1, 'is_extra_packaging_active'])}}"
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="{{route('vendor.business-settings.update-setup',[$restaurant['restaurant_id']])}}" method="post"
        ...
        <div class="card mb-3">
            ...
            @php($default_lang = 'en')
            <div class="card-body">
                <form action="{{route('vendor.business-settings.update-meta-data',[$restaurant['restaurant_id']])}}" method="post"

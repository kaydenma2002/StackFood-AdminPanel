...
class BusinessSettingsController extends Controller
{
    ...
    public function add_schedule(Request $request)
    {
        ...
        $restaurant = $request['vendor']->restaurants[0];
        $temp = RestaurantSchedule::where('day', $request->day)->where('restaurant_id',$restaurant->restaurant_id)
        ...
        $restaurant_schedule = RestaurantSchedule::insertGetId(['restaurant_id'=>$restaurant->restaurant_id,'day'=>$request->day,'opening_time'=>$request->opening_time,'closing_time'=>$request->closing_time]);

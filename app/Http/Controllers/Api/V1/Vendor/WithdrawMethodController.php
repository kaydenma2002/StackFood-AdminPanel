...
class WithdrawMethodController extends Controller
{
    public function get_disbursement_withdrawal_methods(Request $request)
    {
        ...
        $paginator = DisbursementWithdrawalMethod::where('restaurant_id', $restaurant['restaurant_id'])
    ...
    public function disbursement_withdrawal_method_default(Request $request)
    {
        ...
        $method->save();
        DisbursementWithdrawalMethod::whereNot('id', $request->id)->where('restaurant_id',$restaurant['restaurant_id'])->update(['is_default' => 0]);

...
class DeliveryManController extends Controller
{
    ...
    public function get_delivery_man_list(Request $request){
        ...
        $deliveryMen = DeliveryMan::with('last_location')->where('restaurant_id', $restaurant->restaurant_id)->available()->active()->get();
    ...
    public function assign_deliveryman(Request $request){
        ...
        $order= Order::where('id', $request->order_id)->where('restaurant_id', $restaurant->restaurant_id)->with(['subscription.schedule_today','delivery_man'])->firstOrfail();
        if(!$order)
        {
            return response()->json([
                'errors'=>[
        ...
        $deliveryman = DeliveryMan::where('id' ,$request->delivery_man_id)->where('restaurant_id', $restaurant->restaurant_id)->first();

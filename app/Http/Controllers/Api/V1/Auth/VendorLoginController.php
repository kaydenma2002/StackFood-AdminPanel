...
class VendorLoginController extends Controller
{
            ...
            if( $restaurant?->restaurant_model == 'unsubscribed' && isset($restaurant?->restaurant_sub_update_application)){
                ...
                $vendor?->save();
                    ...
                    $data['subscription_other_data'] =  [
                        'total_bill'=>  (float) SubscriptionTransaction::where('restaurant_id', $restaurant->restaurant_id)->where('package_id', $restaurant?->restaurant_sub_update_application?->package?->id)->sum('paid_amount'),
    ...
    public function register(Request $request)
    {
        ...
        foreach ($data as $key=>$i) {
            ...
            $data[$key]['translationable_id'] = $restaurant->restaurant_id;
        }

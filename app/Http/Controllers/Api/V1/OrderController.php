    ...
    public function place_order(Request $request)
    {
        ...
        try {
            ...
            if($request->subscription_order && $request->subscription_quantity){
                ...
                $subscription->restaurant_id = $restaurant->restaurant_id;
                $subscription->save();
            ...
            Helpers::visitor_log(model: 'restaurant', user_id:$customer->id, visitor_log_id:$restaurant->restaurant_id, order_count:true);
            }

...
class CampaignController extends Controller
{
    ...
    public function restaurant_confirmation($campaign,$restaurant_id,$status)
    {
        ...
        try
        {
            ...
            $restaurant_notification_status= Helpers::getRestaurantNotificationStatusData($restaurant->restaurant_id,'restaurant_campaign_join_rejaction');
            ...
            $restaurant_notification_status= Helpers::getRestaurantNotificationStatusData($restaurant->restaurant_id,'restaurant_campaign_join_approval');
